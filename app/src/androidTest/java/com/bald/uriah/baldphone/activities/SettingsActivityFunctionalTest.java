...
public class SettingsActivityFunctionalTest extends BaseActivityTest {
    @Rule
    ...
    @Test
    public void settingsTitleBarIsDisplayed() {
        activityRule.launchActivity(new Intent());
        sleep();
        onView(withId(R.id.title_bar)).check(matches(isDisplayed()));
    }
}
